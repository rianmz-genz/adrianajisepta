const contentData = {
  ...
  projectSection: {
    ...
    projects: [
      ...
      {
        title: "Suit Game",
        description: "Rock paper scissors game that is applied to the website",
        preview: {
          url: "/images/projects/suit.png",
          lowresUrl: "/images/projects/suit.png",
          originalWidth: 1920,
          originalHeight: 1080,
        },
        techs: ["HTML", "CSS", "Vanilla JS"],
        category: ["Competition Project"],
        demoUrl: "https://batuguntingkertas.vercel.app/",
        repoUrl: "https://github.com/rianmz-genz/Suit-game",
      },
    ],
  },
  contactSection: {
